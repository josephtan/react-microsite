...
const Profile=()=> (
    <div className="page-profile has-text-centered">
        ...
        <ul className="has-text-left">
            ...
            <li>Building small to large complex forms with custom validation checking, and integrate them to payment systems / micro-services and have user details written into SQL tables.</li>
